...
namespace DeepFold.PixelPlanets {
	public class LandRivers: GeneratedPixelPlanet {
		
		[SerializeField]
		Color ColorLand1 = ColorUtil.FromRGB("#63AB3F");

		[SerializeField]
		Color ColorLand2 = ColorUtil.FromRGB("#3B7D4F");
		...
		[SerializeField]
		Color ColorRiver = ColorUtil.FromRGB("#4FA4B8");

		[SerializeField]
		Color ColorRiverDark = ColorUtil.FromRGB("#404973");

		[SerializeField]
		Color ColorCloud1 = ColorUtil.FromRGB("#FFFFFF");

		[SerializeField]
		Color ColorCloud2 = ColorUtil.FromRGB("#DFE0E8");
