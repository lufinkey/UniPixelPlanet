...
namespace DeepFold.PixelPlanets {
	public class DryTerran: GeneratedPixelPlanet {
		
		[SerializeField]
		Color ColorLand1 = ColorUtil.FromRGB("#ff8933");

		[SerializeField]
		Color ColorLand2 = ColorUtil.FromRGB("#e64539");

		[SerializeField]
		Color ColorLand3 = ColorUtil.FromRGB("#ad2f45");

		[SerializeField]
		Color ColorLand4 = ColorUtil.FromRGB("#52333f");

		[SerializeField]
		Color ColorLand5 = ColorUtil.FromRGB("#3d2936");
