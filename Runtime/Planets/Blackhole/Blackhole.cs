...
namespace DeepFold.PixelPlanets {
	public class Blackhole: GeneratedPixelPlanet {

		[SerializeField]
		GameObject BlackholeObj;

		[SerializeField]
		GameObject BlackholeRingObj;

		[SerializeField]
		Color ColorBlack = ColorUtil.FromRGB("#272736");

		[SerializeField]
		Color ColorHole1 = ColorUtil.FromRGB("#ffffeb");

		[SerializeField]
		Color ColorHole2 = ColorUtil.FromRGB("#ed7b39");

		[SerializeField]
		Color ColorRing1 = ColorUtil.FromRGB("#ffffeb");

		[SerializeField]
		Color ColorRing2 = ColorUtil.FromRGB("#fff540");

		[SerializeField]
		Color ColorRing3 = ColorUtil.FromRGB("#ffb84a");

		[SerializeField]
		Color ColorRing4 = ColorUtil.FromRGB("#ed7b39");

		[SerializeField]
		Color ColorRing5 = ColorUtil.FromRGB("#bd4035");
