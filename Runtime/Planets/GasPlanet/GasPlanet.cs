...
namespace DeepFold.PixelPlanets {
	public class GasPlanet: GeneratedPixelPlanet {

		[SerializeField]
		Color ColorCloud1_1 = ColorUtil.FromRGB("#3b2027");

		[SerializeField]
		Color ColorCloud1_2 = ColorUtil.FromRGB("#3b2027");

		[SerializeField]
		Color ColorCloud1_3 = ColorUtil.FromRGB("#21181b");

		[SerializeField]
		Color ColorCloud1_4 = ColorUtil.FromRGB("#21181b");

		[SerializeField]
		Color ColorCloud2_1 = ColorUtil.FromRGB("#f0b541");

		[SerializeField]
		Color ColorCloud2_2 = ColorUtil.FromRGB("#cf752b");

		[SerializeField]
		Color ColorCloud2_3 = ColorUtil.FromRGB("#ab5130");

		[SerializeField]
		Color ColorCloud2_4 = ColorUtil.FromRGB("#7d3833");
