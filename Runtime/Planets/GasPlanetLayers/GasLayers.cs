...
namespace DeepFold.PixelPlanets {
	public class GasLayers: GeneratedPixelPlanet {

		[SerializeField]
		Color Color1 = ColorUtil.FromRGB("#eec39a");

		[SerializeField]
		Color Color2 = ColorUtil.FromRGB("#d9a066");

		[SerializeField]
		Color Color3 = ColorUtil.FromRGB("#8f563b");

		[SerializeField]
		Color ColorDark1 = ColorUtil.FromRGB("#663931");

		[SerializeField]
		Color ColorDark2 = ColorUtil.FromRGB("#45283c");

		[SerializeField]
		Color ColorDark3 = ColorUtil.FromRGB("#222034");

		[SerializeField]
		GameObject GasPlanet;
