...
namespace DeepFold.PixelPlanets {
	public class IceWorld: GeneratedPixelPlanet {

		[SerializeField]
		Color ColorLand1 = ColorUtil.FromRGB("#faffff");

		[SerializeField]
		Color ColorLand2 = ColorUtil.FromRGB("#c7d4e1");

		[SerializeField]
		Color ColorLand3 = ColorUtil.FromRGB("#928fb8");

		[SerializeField]
		Color ColorLakes1 = ColorUtil.FromRGB("#4fa4b8");

		[SerializeField]
		Color ColorLakes2 = ColorUtil.FromRGB("#4c6885");

		[SerializeField]
		Color ColorLakes3 = ColorUtil.FromRGB("#3a3f5e");

		[SerializeField]
		Color ColorCloud1 = ColorUtil.FromRGB("#e1f2ff");

		[SerializeField]
		Color ColorCloud2 = ColorUtil.FromRGB("#c0e3ff");

		[SerializeField]
		Color ColorCloud3 = ColorUtil.FromRGB("#5e70a5");

		[SerializeField]
		Color ColorCloud4 = ColorUtil.FromRGB("#404973");

		[SerializeField]
		GameObject PlanetUnder;
