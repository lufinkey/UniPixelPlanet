...
namespace DeepFold.PixelPlanets {
	public class LandMasses: GeneratedPixelPlanet {

		[SerializeField]
		Color ColorLand1 = ColorUtil.FromRGB("#C8D45D");

		[SerializeField]
		Color ColorLand2 = ColorUtil.FromRGB("#63AB3F");

		[SerializeField]
		Color ColorLand3 = ColorUtil.FromRGB("#2F5753");

		[SerializeField]
		Color ColorLand4 = ColorUtil.FromRGB("#283540");

		[SerializeField]
		Color ColorWater1 = ColorUtil.FromRGB("#92E8C0");

		[SerializeField]
		Color ColorWater2 = ColorUtil.FromRGB("#4FA4B8");

		[SerializeField]
		Color ColorWater3 = ColorUtil.FromRGB("#2C354D");

		[SerializeField]
		Color ColorCloud1 = ColorUtil.FromRGB("#DFE0E8");

		[SerializeField]
		Color ColorCloud2 = ColorUtil.FromRGB("#A3A7C2");

		[SerializeField]
		Color ColorCloud3 = ColorUtil.FromRGB("#686F99");

		[SerializeField]
		Color ColorCloud4 = ColorUtil.FromRGB("#404973");
