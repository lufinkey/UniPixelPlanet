...
namespace DeepFold.PixelPlanets {
	public class LavaWorld: GeneratedPixelPlanet {

		[SerializeField]
		Color ColorLand1 = ColorUtil.FromRGB("#8f4d57");

		[SerializeField]
		Color ColorLand2 = ColorUtil.FromRGB("#52333f");

		[SerializeField]
		Color ColorLand3 = ColorUtil.FromRGB("#3d2936");

		[SerializeField]
		Color ColorCrater1 = ColorUtil.FromRGB("#52333f");

		[SerializeField]
		Color ColorCrater2 = ColorUtil.FromRGB("#3d2936");

		[SerializeField]
		Color ColorRiver1 = ColorUtil.FromRGB("#ff8933");

		[SerializeField]
		Color ColorRiver2 = ColorUtil.FromRGB("#e64539");

		[SerializeField]
		Color ColorRiver3 = ColorUtil.FromRGB("#ad2f45");
