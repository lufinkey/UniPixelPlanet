...
namespace DeepFold.PixelPlanets {
	public class Galaxy: GeneratedPixelPlanet {

		[SerializeField]
		Color Color1 = ColorUtil.FromRGB("#ffffeb");

		[SerializeField]
		Color Color2 = ColorUtil.FromRGB("#ffe478");

		[SerializeField]
		Color Color3 = ColorUtil.FromRGB("#8fde5d");

		[SerializeField]
		Color Color4 = ColorUtil.FromRGB("#3d6e70");

		[SerializeField]
		Color Color5 = ColorUtil.FromRGB("#323e4f");

		[SerializeField]
		Color Color6 = ColorUtil.FromRGB("#322947");
