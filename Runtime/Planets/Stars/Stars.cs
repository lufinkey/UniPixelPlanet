...
namespace DeepFold.PixelPlanets {
	public class Stars: GeneratedPixelPlanet {
		[SerializeField]
		Color ColorBackground = ColorUtil.FromRGB("#ffffe4");

		[SerializeField]
		Color ColorStar1 = ColorUtil.FromRGB("#f5ffe8");

		[SerializeField]
		Color ColorStar2 = ColorUtil.FromRGB("#77d6c1");

		[SerializeField]
		Color ColorStar3 = ColorUtil.FromRGB("#1c92a7");

		[SerializeField]
		Color ColorStar4 = ColorUtil.FromRGB("#033e5e");

		[SerializeField]
		Color ColorFlare1 = ColorUtil.FromRGB("#77d6c1");

		[SerializeField]
		Color ColorFlare2 = ColorUtil.FromRGB("#ffffe4");

		[SerializeField]
		GameObject StarBackground;

		[SerializeField]
		GameObject Star;

		[SerializeField]
		GameObject StarFlares;
