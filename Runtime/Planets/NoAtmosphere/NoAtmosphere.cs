...
namespace DeepFold.PixelPlanets {
	public class NoAtmosphere : GeneratedPixelPlanet {

		[SerializeField]
		Color ColorLand1 = ColorUtil.FromRGB("#A3A7C2");

		[SerializeField]
		Color ColorLand2 = ColorUtil.FromRGB("#4C6885");

		[SerializeField]
		Color ColorLand3 = ColorUtil.FromRGB("#3A3F5E");

		[SerializeField]
		Color ColorCrater1 = ColorUtil.FromRGB("#4C6885");

		[SerializeField]
		Color ColorCrater2 = ColorUtil.FromRGB("#3A3F5E");
